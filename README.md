...
*  __ThreadLocal实现原理是什么?__
    ...
    * __你怎么理解cookie和session，有哪些不同点?__
...
* __什么是过滤器、拦截器、监听器，它们的顺序是怎样的?__ 

     监听器> 过滤器 > 拦截器
     
* __Servlet3.0有哪些新规范?__
     ...
     [Servlet3.0规范](http://blog.csdn.net/zcl_love_wx/article/details/52075428)
     
* __常见的攻击手段有哪些?如何防范?__
...
* __RESTFUL API 有哪些设计原则?__
     ...
     ### 总结：
     以上是Java基础，以及Java Web 相关资料整理，希望能帮助到你！！！  有写错的地方，勿喷！！！
